...
def get_dataset(dataset_name, cfg):
    ...
    elif dataset_name == 'COCO_MVal_seen':
        dataset = DavisDataset(cfg.COCO_MVAL_SEEN_PATH)
    elif dataset_name == 'COCO_MVal_unseen':
        dataset = DavisDataset(cfg.COCO_MVAL_UNSEEN_PATH)
    else:
        dataset = None
