...
class SBDDataset(ISDataset):
    ...
    def get_sample(self, index):
        ...
        return DSample(image, instances_mask, objects_ids=instances_ids, sample_id=index, image_name=image_name)
...
class SBDEvaluationDataset(ISDataset):
    ...
    def get_sample(self, index) -> DSample:
        ...
        return DSample(image, instances_mask, objects_ids=[1], sample_id=index, image_name=image_name+'+'+str(instance_id))
